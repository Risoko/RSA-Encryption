...
def decryption(path_for_encryption_file: str):
    """
    The function decrypts the encrypted file. 
    The function takes the path to the file.
    """
    check_path(path_for_encryption_file)
